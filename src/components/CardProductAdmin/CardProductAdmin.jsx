...
const CardProductAdmin = ({ type, img, title, price, productId, onDelete, onUpdate, onDeleteRequest }) => {
  ...
  const handleDeleteClick = () => {
    if (onDeleteRequest) onDeleteRequest(productId); // Gọi callback khi nhấn nút xóa
  };
