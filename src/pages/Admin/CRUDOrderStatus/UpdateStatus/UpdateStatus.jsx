...
const UpdateStatus = () => {
    const [orders, setOrders] = useState([
        { id: 1, code: 'S1', status: 'Đang làm', receivedDate: '5/1/2024', deliveryDate: '6/1/2024', total: '625,000 VND' },
        { id: 2, code: 'S2', status: 'Đang làm', receivedDate: '5/1/2024', deliveryDate: '5/1/2024', total: '450,000 VND' },
        { id: 3, code: 'S3', status: 'Đang làm', receivedDate: '5/1/2024', deliveryDate: '5/1/2024', total: '1,000,000 VND' },
        { id: 4, code: 'S4', status: 'Đang làm', receivedDate: '5/1/2024', deliveryDate: '5/1/2024', total: '200,000 VND' },
    ]);
    ...
    const updateStatus = () => {
        const newStatusIndex = (statuses.indexOf(currentStatus) + 1) % statuses.length;
                ...
                <div className='right-area-UpdateStatus'>
                    ...
                    <div className='BtnHolder-UpdateStatus'>
                        <div className='UpdateStatus-btn'>
                            <ButtonComponent onClick={updateStatus} disabled={isLastStatus} className='UpdateStatus-btnCustom'>Cập nhật trạng thái</ButtonComponent>
                        </div>
                        <div className='ExitHolder-btn'>
                            <ButtonComponent className='ExitBtn-Custom-updatestatus' onClick={handelClcikExit}>Thoát</ButtonComponent>
                        </div>
                    </div>
                </div>
            </div>
